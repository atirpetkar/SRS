...
class TestFSRSAlgorithm:
    ...
    def test_first_review_success(self):
        ...
        assert updated_state.due_at > datetime.now(timezone.utc)
    ...
    def test_progressive_intervals(self):
        ...
        assert all(interval >= 1 for interval in intervals)  # All intervals should be at least 1 day
    ...
    def test_difficulty_adjustment(self):
        ...
        scheduler = FSRSScheduler()
        state = scheduler.seed("user123", "item456")
        initial_difficulty = state.difficulty
    ...
    def test_retrievability_calculation(self):
        ...
        assert scheduler._calculate_retrievability(10.0, 1) > scheduler._calculate_retrievability(1.0, 1)
