...
from api.v1.review.models import SchedulerState, Review
...
class TestReviewQueue:
    ...
    @pytest.mark.asyncio
    async def test_empty_queue(self, async_client: AsyncClient, db_session: AsyncSession):
    ...
    @pytest.mark.asyncio
    async def test_queue_with_new_items(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
        ...
        item2 = Item(
            org_id=sample_org.id,
            type="mcq",
            payload={"stem": "What is 2+2?", "options": [{"id": "a", "text": "3"}, {"id": "b", "text": "4", "is_correct": True}]},
            status="published"
        )
    ...
    @pytest.mark.asyncio
    async def test_queue_with_due_items(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_queue_mixed_items(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
        ...
        past_due = datetime.now(timezone.utc) - timedelta(minutes=30)
        state = SchedulerState(
            user_id=str(sample_user.id),
            item_id=due_item.id,
            difficulty=4.0,
    ...
    @pytest.mark.asyncio
    async def test_queue_filtering(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_queue_draft_items_excluded(self, async_client: AsyncClient, db_session: AsyncSession, sample_org):
...
class TestReviewRecording:
    ...
    @pytest.mark.asyncio
    async def test_record_review_new_item(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_record_review_existing_item(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_record_review_lapse(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
    ...
    @pytest.mark.asyncio
    async def test_record_review_invalid_rating(self, async_client: AsyncClient, db_session: AsyncSession, sample_org):
    ...
    @pytest.mark.asyncio
    async def test_record_review_creates_review_record(self, async_client: AsyncClient, db_session: AsyncSession, sample_org, sample_user):
