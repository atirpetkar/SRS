...
down_revision: str | Sequence[str] | None = "e993aae79d58"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "due_at", sa.dialects.postgresql.TIMESTAMP(timezone=True), nullable=False
        ),
    ...
    op.create_index(
        "idx_scheduler_state_user_due", "scheduler_state", ["user_id", "due_at"]
    )
